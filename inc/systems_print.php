			  <fieldset>
				...
				<div class="row">
					...
					if ($_POST['focus1-1_other']=="Other") {
		                ...
		                echo '<p>'.$_POST['focus1-1_other_number']." - ".$_POST['focus1-1_other_title']." - ".$_POST['focus1-1_other_units'].'</p>';
		                echo '</div>';
				    }

					if ($_POST['focus1-2_other']=="Other") {
		                echo '<div class="small-4 columns">';
		                echo '<p>'.$_POST['focus1-2_other_number']." - ".$_POST['focus1-2_other_title']." - ".$_POST['focus1-2_other_units'].'</p>';
		                echo '</div>';
				    }
